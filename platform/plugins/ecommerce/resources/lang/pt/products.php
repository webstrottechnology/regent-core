...
return [
    ...
    'form' => [
        ...
        'description_placeholder' => 'Descrição curta para o produto (Máximo 400 caracteres)',
        ...
        'stock' => [
            'allow_order_when_out' => 'Permitir checkout do cliente quando este produto estiver fora de estoque',
            'in_stock' => 'Em estoque',
        ...
        'tax' => 'Imposto',
        'taxes' => 'Impostos',
        'taxes_helper' => 'A alíquota de imposto padrão é configurada em <a href=":url">Configurações -> Imposto</a>. Se nenhum imposto específico for selecionado para este produto, a alíquota padrão será aplicada. Para desabilitar o imposto para este produto, remova a alíquota de imposto padrão das configurações de imposto.',
        'is_default' => 'É padrão',
        'action' => 'Ação',
        ...
        'add_more_attribute' => 'Adicionar mais atributo',
        'continue' => 'Continuar',
        ...
        'video' => 'Vídeo',
        'video_file' => 'Arquivo',
        'video_url' => 'Ou URL de Vídeo Externa',
        ...
        'video_thumbnail_help' => 'Escolha uma miniatura para o vídeo. Se não selecionada, será obtida automaticamente da URL do vídeo se disponível.',
    ...
    'brand' => 'Marca',
    'cannot_delete' => 'Produto não pôde ser excluído',
    ...
    'up_selling_products' => 'Produtos de up-selling',
    ...
    'product_create_validate_sale_price_required_if' => 'Deve digitar um desconto quando quiser agendar uma promoção',
    'product_create_validate_end_date_after' => 'Data de fim deve ser após a data de início',
    'product_create_validate_start_date_required_if' => 'Data de início do desconto não pode ficar em branco quando o agendamento é selecionado',
    'product_create_validate_sale_price' => 'Descontos não podem ficar em branco quando o agendamento é selecionado',
    'stock_statuses' => [
        'in_stock' => 'Em estoque',
        'out_of_stock' => 'Fora de estoque',
        'on_backorder' => 'Em pré-pedido',
    ],
    'stock_status' => 'Status do estoque',
    ...
    'category' => 'Categoria',
    'product_price_flash_sale_warning' => 'Este produto está na promoção relâmpago <strong>:name</strong> então seu preço é <strong>:price</strong>.',
    'product_price_discount_warning' => 'Este produto está no desconto <strong>:name</strong> então seu preço é <strong>:price</strong>.',
    ...
    'digital_attachments' => [
        ...
        'enter_external_link_download' => 'Digite o link externo para download',
        'enter_file_size' => 'Digite o tamanho do arquivo',
        'external_link_download' => 'Link externo para download',
        'generate_license_code_after_purchasing_product' => 'Habilitar atribuição de código de licença para este produto',
        'notify_attachment_updated' => 'Enviar um e-mail ao cliente quando o anexo for atualizado',
    ],
    'license_codes' => [
        ...
        'management' => 'Gerenciamento de Código de Licença',
        'variation_breadcrumb' => 'Variação: :name',
        'variation_label' => 'Variação do Produto',
        'variation_specific_note' => 'Estes códigos de licença são específicos para esta variação do produto. Clientes que comprarem esta variação receberão códigos desta reserva.',
        'main_product_note' => 'Este produto tem variações. Cada variação pode ter seus próprios códigos de licença, ou os clientes podem receber códigos desta reserva principal do produto se a variação não tiver códigos.',
        ...
        'no_codes_warning_message' => 'Este produto está configurado para "Escolher da Lista" mas não tem códigos de licença disponíveis. Clientes que comprarem este produto receberão códigos gerados automaticamente. Por favor, adicione códigos de licença para garantir o funcionamento adequado.',
        'no_codes_auto_generate' => 'Este produto está configurado para gerar códigos de licença automaticamente. Nenhum código manual necessário.',
        ...
        'generated_successfully' => 'Gerados :count códigos de licença com sucesso!',
        'duplicates_skipped' => ':count códigos duplicados foram ignorados.',
        'generation_incomplete' => 'Aviso: Só foi possível gerar :generated de :requested códigos solicitados devido a conflitos de duplicatas.',
        ...
        'more' => 'mais',
        'used_codes_hidden' => ':count código(s) de licença usado(s) estão ocultos. Você pode visualizar todos os códigos na página de Gerenciamento de Código de Licença.',
        'low_stock_title' => 'Estoque Baixo de Código de Licença',
        'low_stock_message' => 'Apenas :count códigos de licença restantes. Considere adicionar mais códigos para evitar ficar sem.',
        'out_of_stock_title' => 'Sem Códigos de Licença!',
        'out_of_stock_message' => 'Nenhum código de licença disponível. Clientes receberão códigos gerados automaticamente até você adicionar mais.',
        'type' => [
            'title' => 'Método de Atribuição de Código de Licença',
            'auto_generate' => 'Gerar Automaticamente (Sistema gera códigos automaticamente)',
        ...
        'errors' => [
            ...
            'not_digital_product' => 'Códigos de licença estão disponíveis apenas para produtos digitais. Este produto está configurado como um produto físico.',
            'license_codes_not_enabled_for_product' => 'O gerenciamento de código de licença não está habilitado para este produto. Por favor, habilite "Gerar código de licença após comprar produto" nas configurações do produto.',
    ...
    'cross_sell_help' => [
        'price' => '* Campo Preço',
        'price_description' => 'Digite o valor que você quer reduzir do preço original. Exemplo: Se o preço original é R$ 100, digite 20 para reduzir o preço para R$ 80.',
        'type' => '* Campo Tipo',
    ...
    'export' => [
        'description' => 'Exporte seus dados de produto para arquivos CSV ou Excel.',
        ...
        'use_chunked_export_helper' => 'Processar dados em lotes para lidar com grandes conjuntos de dados de forma eficiente',
        ...
        'chunk_size_helper' => 'Número de produtos para processar por vez (50-5000)',
        ...
        'large_dataset_specific_message' => 'Para seus :count produtos, use formato CSV com streaming habilitado. O sistema agora pode lidar com seu grande catálogo de produtos de forma eficiente sem timeouts ou problemas de memória.',
        ...
        'pro_tip_message' => 'A exportação continuará funcionando mesmo se seu navegador mostrar um indicador de carregamento. Uma vez iniciada, o download começará automaticamente.',
        'large_dataset_tip_1' => 'Formato Excel foi desabilitado - use formato CSV para exportações mais rápidas e confiáveis',
        'large_dataset_tip_2' => 'Modo streaming foi habilitado automaticamente para prevenir timeouts',
        'large_dataset_tip_3' => 'Processo de exportação pode levar 1-3 minutos dependendo do seu servidor',
        'large_dataset_recommendation' => 'Recomendado: Use formato CSV com tamanho de lote 200-500 para desempenho ideal.',
        'excel_disabled_for_large_export' => 'Formato Excel não disponível para catálogos com mais de 10.000 itens',
        'streaming_auto_enabled' => 'Modo streaming foi habilitado automaticamente para desempenho ideal com grandes conjuntos de dados.',
        'streaming_enabled_title' => 'Otimizado para Exportação Grande',
        'streaming_enabled_message' => 'Modo streaming está ativo para garantir exportação suave sem problemas de memória.',
        'use_multi_file' => 'Usar exportação multi-arquivo',
        'use_multi_file_helper' => 'Dividir exportação em vários arquivos empacotados em um ZIP para conjuntos de dados muito grandes',
        ...
        'medium_dataset_message' => 'Você está exportando :count produtos. Considere usar exportação em lotes para melhor desempenho.',
        'optimal_range' => 'Faixa ideal',
        'too_small_slow' => 'Muito pequeno - pode ser lento',
        'too_large_timeouts' => 'Muito grande - pode causar timeouts',
        'excel_disabled_warning' => 'Formato Excel desabilitado para exportações grandes (:count itens)',
    ...
    'import' => [
        'description' => 'Importe seus dados de produto de arquivos CSV ou Excel.',
        'rules' => [
            ...
            'nullable_string_max' => ':attribute pode ficar vazio ou deve ser uma string com comprimento máximo de :max caracteres se fornecido',
            'nullable_bool' => 'Se :attribute pode ficar vazio ou deve ser um valor booleano se fornecido.',
            'nullable_numeric_min' => ':attribute pode ficar vazio ou deve ser um número não negativo se fornecido.',
            'nullable_numeric_min_max' => ':attribute pode ficar em branco ou deve ser um número entre :min e :max se fornecido.',
        ...
        'updated_message' => 'Atualizados :count produtos com sucesso!',
    ],
    'import_products_intro' => 'Ou importe produtos do CSV/Excel',
