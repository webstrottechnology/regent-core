...
return [
    ...
    'warning_prices' => 'Estes preços representam os custos originais do produto e podem não refletir os preços finais, que podem variar devido a fatores como promoções relâmpago, promoções e mais.',

    'import' => [
        'name' => 'Atualizar Preços de Produtos',
        'description' => 'Atualize os preços dos produtos em lote enviando um arquivo CSV/Excel.',
