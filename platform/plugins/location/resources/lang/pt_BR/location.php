...
return [
    ...
    'export' => [
        ...
        'large_dataset_title' => 'Grande conjunto de dados detectado',
        ...
        'large_dataset_specific_message' => 'Você está exportando :count localizações. Para um desempenho ideal, recomendamos usar o formato CSV com exportação em lotes.',
        ...
        'pro_tip_message' => 'Você pode filtrar por tipo de localização (país/estado/cidade) para exportar dados específicos.',
        'medium_dataset_detected' => 'Conjunto de dados médio detectado',
        'medium_dataset_message' => 'Exportando :count localizações. A exportação deverá ser concluída em 1-2 minutos.',
